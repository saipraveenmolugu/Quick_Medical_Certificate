...
const socialLinks = [
    ...
    { icon: TwitterIcon, href: SOCIAL_LINKS.twitter, label: "X (Twitter)" },
];
...
export default function Footer() {
    ...
    const legalLinks = [
        ...
        { label: "Medical Disclaimer", href: "/terms#disclaimer" },
    ];
        ...
        <footer className="bg-gray-900 text-white">
            ...
            <div className="container mx-auto px-4 py-12 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <Link href="/" className="inline-block mb-6">
                            <span className="text-2xl font-bold">
                                ...
                                <span className="text-white">MedicalCertificate</span>
                            </span>
                        </Link>
                        <p className="text-gray-400 mb-6 max-w-sm">
                            Get your medical certificate quickly and securely from NMC-registered doctors.
                        ...
                        <div className="space-y-3 mb-6">
                            ...
                            <a href="mailto:support@quickmedicalcertificate.com" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
                                ...
                                <span className="text-sm">support@quickmedicalcertificate.com</span>
                            </a>
                    ...
                    {/* Certificates Column */}
                    <div>
                        <h4 className="font-bold text-white mb-4">Certificates</h4>
                        <ul className="space-y-2">
                            {[...leaveCertificates, ...fitnessCertificates].slice(0, 6).map((cert, i) => (
                                <li key={i}>
                                    <Link
                    ...
                    <div>
                        ...
                        <div className="mt-6 space-y-2">
                            ...
                            <div className="flex items-center gap-2 text-gray-400 text-xs">
                                ...
                                <span>NMC Registered Doctors</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4 py-4 md:py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p className="text-gray-500 text-xs md:text-sm text-center md:text-left">
                            © {new Date().getFullYear()} QuickMedicalCertificate.com. All rights reserved.
                        </p>
                    ...
                    <p className="text-gray-600 text-[10px] text-center mt-4 max-w-4xl mx-auto">
                        *Terms and conditions apply. Medical certificates are subject to doctor&apos;s approval.
                        QuickMedicalCertificate.com is a facilitating platform only and does not issue medical certificates directly.
                    </p>
                </div>
            </div>
        </footer>
